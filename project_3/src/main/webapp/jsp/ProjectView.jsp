					...
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<div class="md-form">
								...
								<font color="red" class="pl-sm-5" id = "descriptionError"> <%=ServletUtility.getErrorMessage("name", request)%></font></br>
...
<script>document.addEventListener('DOMContentLoaded', function() {
            var descriptionValue = "<%= DataUtility.getStringData(dto.getName()) %>";
            console.log('Description value:', descriptionValue);
            document.getElementById('name').value = descriptionValue;
        });</script>
</body>
</html>
