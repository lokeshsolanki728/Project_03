	...
	<div>
		<form class="pb-5" action="<%=ORSView.INVENTORY_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="date" placeholder="Enter Last Update Date"
				 ...
				 <div class="col-sm-2">
					<input type="text" name="quantity" placeholder="Enter  Quantity"
						class="form-control" oninput="validateVersion(event)" maxlength="20"
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: blue;">
							...
							<th width="15%" class="text"> Last Update Date</th>
							<th width="20%" class="text">Quantity</th>
							<th width="5%" class="text">Product</th>
